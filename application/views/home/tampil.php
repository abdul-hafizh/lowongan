	<div class="col-md-9 col-lg-10 main">
		...
		<p class="lead">
			<?php
			if (isset($admin)){
				echo "Selamat Datang $admin->nama_admin";
			} else if (isset($perusahaan)){
				echo "Selamat Datang $perusahaan->nama_penanggung_jawab";
			} else if (isset($pengguna)){
				echo "Selamat Datang $pengguna->nama_pengguna";
			} else {
				echo "Selamat Mencari Lowongan";
			}
			?>
		</p>
