        <div class="col-md-9 col-lg-10 main">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-8">
                    ...
                    <?php endif ?>
                    <p><a href="<?= base_url("lowongan/tambah") ?>"><button type="button" class="btn btn-default">Tambah</button></a></p>
                            ...
                            <tbody>
                                <?php foreach ((array) $lowongans as $key => $lowongan) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?=  base_url("lowongan/ubah/$lowongan->id_lowongan")?>" >Ubah</a></td>
                                        <td><a class="nav-link" href="<?=  base_url("lowongan/ubah/$lowongan->id_lowongan")?>" data-target="#myModal" data-toggle="modal">Hapus</a></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
